            ...
            <tbody>
                ...
                @foreach ($orders as $order)
                    ...
                    <tr>
                        ...
                        <td>{{ $order->final_total_amount }}</td>
                        ...
                        <td>
                            ...
                            <span class="label label-danger arrowed-in">CashOnDelivery</span>
                            @elseif($order->payment_status == 2)
                            <span class="label label-success arrowed">Complete</span>
                            @endif
                        </td>
                        <td>
                            <span class="label label-warning arrowed-in-right arrowed-in">New</span>
                        </td>
                        <td>
                            <a href="{{ route('backend.orderDetails',$order->id) }}"><span class="label label-lg label-pink arrowed-right">Details</span></a>
                            {{-- <div class="btn-group">
